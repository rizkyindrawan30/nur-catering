                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_paket" class="form-control @error('nama_paket') is-invalid @enderror" id="nama_paket" value="{{ old('nama_paket') }}" placeholder="Nama Paket">
                            @error('nama_paket')
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="number" name="harga" class="form-control @error('harga') is-invalid @enderror" id="harga" placeholder="Harga Paket">
                            @error('harga')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select class="form-select @error('category_id') is-invalid @enderror" name="category_id" id="category">
                                ...
                                <option value="{{ $item->id }}" {{old('category_id') == $item->id ? 'selected' : null}}>{{ $item->category }}</option>
                                @endforeach
                            </select>
                            @error('category_id')
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input id="menu_paket" type="hidden" name="menu_paket" value="{{ old('menu_paket') }}">
